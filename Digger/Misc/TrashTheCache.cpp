...
digger::TrashTheCache::TrashTheCache(rift2d::GameObject* owner):
BaseComponent(owner)
{
}

void digger::TrashTheCache::init()
{
	BaseComponent::init();
	m_pLineGraph = getOwner()->addComponent<rift2d::LineGraph>("GameObject3D");
	m_pLineGraphAlt = getOwner()->addComponent<rift2d::LineGraph>("GameObject3DAlt");
	m_pLineGraphCombined = getOwner()->addComponent<rift2d::LineGraph>("Combined");
	m_pLineGraphBasic = getOwner()->addComponent<rift2d::LineGraph>("Basic");
...
void digger::TrashTheCache::update()
{
...
void digger::TrashTheCache::onImGui()
{
...
void digger::TrashTheCache::onComponentRemoved(BaseComponent* component)
{
...
void digger::TrashTheCache::TrashTheCacheEx1()
{
...
void digger::TrashTheCache::TrashTheCacheEx2()
{
...
void digger::TrashTheCache::TrashTheCacheEx3()
{
