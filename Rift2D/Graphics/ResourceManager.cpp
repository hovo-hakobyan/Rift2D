...
std::unique_ptr<rift2d::Texture2D> rift2d::ResourceManager::createFontTexture(Font* font, const RiftColor& color, const std::string& text)
{
	SDL_Color sdlColor = { color.r, color.g, color.b, color.a };
	const auto surf = TTF_RenderText_Blended(font->getFont(), text.c_str(), sdlColor);
	if (surf == nullptr)
	{
